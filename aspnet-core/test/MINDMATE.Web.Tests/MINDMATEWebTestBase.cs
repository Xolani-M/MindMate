...
{
    public abstract class MINDMATEWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MINDMATEWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MINDMATEWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MINDMATEDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MINDMATEDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MINDMATEDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MINDMATEDbContext, Task<T>> func)
        {
            T result;
